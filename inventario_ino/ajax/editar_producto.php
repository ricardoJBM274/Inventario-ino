...
if (empty($_POST['mod_id'])) {
	...
	$sql = "UPDATE products SET codigo_producto='" . $codigo . "', nombre_producto='" . $nombre . "', id_categoria='" . $categoria . "',estado='" . $estado . "', num_serie='" . $precio_venta . "', stock='" . $stock . "' WHERE id_producto='" . $id_producto . "'";
