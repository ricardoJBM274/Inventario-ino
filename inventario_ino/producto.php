...
if (isset($_POST['reference']) and isset($_POST['quantity'])) {
	...
	$nota = "Se agregó $reference producto(s) al inventario";
...
if (isset($_POST['reference_remove']) and isset($_POST['quantity_remove'])) {
	...
	$user_id = $_SESSION['user_id'];
	$firstname = $_SESSION['firstname'];
	$nota = "Se eliminó $reference producto(s) del inventario";
	$fecha = date("Y-m-d H:i:s");
	guardar_historial($id_producto, $user_id, $fecha, $nota, $reference, $quantity);
					...
					<div class="panel-body">
						<div class="row">
							<div class="col-sm-4 col-sm-offset-2 text-center">
								...
								<a href="#myModal2" data-toggle="modal" data-codigo='<?php echo $row['codigo_producto']; ?>' data-nombre='<?php echo $row['nombre_producto']; ?>' data-categoria='<?php echo $row['id_categoria'] ?>' data-precio='<?php echo $row['num_serie'] ?>' data-stock='<?php echo $row['stock']; ?>' data-estado='<?php echo $row['estado']; ?>' data-id='<?php echo $row['id_producto']; ?>' class="btn btn-info" title="Editar"> <i class="glyphicon glyphicon-pencil"></i> Editar </a>
							...
							<div class="col-sm-4 text-left">
								<div class="row margin-btm-20">
									...
									<div class="col-sm-12 margin-btm-10">
										<span class="item-title">Código: <?php echo $row['codigo_producto']; ?></span>
									</div>
									<div class="col-sm-12 margin-btm-10">
									</div>
									<div class="col-sm-12">
									...
									<div class="col-sm-12 margin-btm-10">
										<span class="item-title"><?php echo $row['stock']; ?></span>
									</div>
									<div class="col-sm-12">
										<span class="current-stock"> Número de serie </span>
									</div>
									<div class="col-sm-12">
										<span class="item-title"><?php echo $row['num_serie'] ?></span>
									</div>
									<div class="col-sm-12">
										<span class="current-stock"> Estado del producto </span>
									</div>
									<div class="col-sm-12">
										<span class="item-title"><?php echo $row['estado'] ?></span>
									</div>
									<div class="col-sm-12 margin-btm-10">
									</div>
